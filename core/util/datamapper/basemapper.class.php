...
abstract class BaseMapper extends Mapper
{
    ...
    public function save(Composite $object)
    {
        $this->obj = $object;
    }
    ...
    {
        $properties = $this->obj;if (!$this->obj){debug_print_backtrace();exit;}
        $properties = $properties->reflect;
        $properties = $properties->getProperty('properties');
        $properties = $properties->getValue($this->obj);
